...
<head>
	...
	<!-- SITE TITLE -->
	<title>Eats.lk - Pizza and Fast Food Restaurant</title>
		...
		<div class="blockChanger bgChanger">
			...
			<div class="chBody white-color">
				...
				<div class="stBlock text-center" style="margin: 30px 20px 20px 26px">
					<p>Choose Demo</p>
					<a class="s_1" href="index.html"><img src="images/color-scheme/l-01.jpg" width="180" height="93"
							alt="layout-image"></a>
					<a class="s_1" href="index-2.html"><img src="images/color-scheme/l-02.jpg" width="180" height="130"
							alt="layout-image"></a>
					<a class="s_1" href="index-3.html"><img src="images/color-scheme/l-03.jpg" width="180" height="98"
							alt="layout-image"></a>
					<a class="s_1" href="index-4.html"><img src="images/color-scheme/l-04.jpg" width="180" height="115"
							alt="layout-image"></a>
					<a class="s_1" href="index-5.html"><img src="images/color-scheme/l-05.jpg" width="180" height="118"
							alt="layout-image"></a>
					<a class="s_1" href="index-6.html"><img src="images/color-scheme/l-06.jpg" width="180" height="93"
							alt="layout-image"></a>
					<a class="s_1" href="index-7.html"><img src="images/color-scheme/l-07.jpg" width="180" height="121"
							alt="layout-image"></a>
					<a class="s_1" href="index-8.html"><img src="images/color-scheme/l-08.jpg" width="180" height="115"
							alt="layout-image"></a>
					<a class="s_1" href="index-9.html"><img src="images/color-scheme/l-09.jpg" width="180" height="109"
							alt="layout-image"></a>
					<a class="s_1" href="index-10.html"><img src="images/color-scheme/l-10.jpg" width="180" height="125"
							alt="layout-image"></a>
					<a class="s_1" href="index-11.html"><img src="images/color-scheme/l-11.jpg" width="180" height="128"
							alt="layout-image"></a>
					<a class="s_1" href="index-12.html"><img src="images/color-scheme/l-12.jpg" width="180" height="123"
							alt="layout-image"></a>
				</div>
	...
	<header id="header-3" class="header navik-header header-transparent header-shadow">
		<div class="container">
			...
			<div class="navik-header-container">
				...
				<!-- CALL BUTTON -->
				<div class="callusbtn text-right"><a href="tel:94768228544"><i class="fas fa-phone"></i></a></div>
				...
				<nav class="navik-menu menu-caret navik-yellow">
					<ul class="top-list text-right">
						...
						<li><a href="#">About</a>
							<ul>
								<li><a href="about.html">About EatsLK</a></li>
						...
						<!-- HEADER BUTTON  -->
						<li class="nav-btn yellow-color"><a href="tel:+9470 822 85 44">44 85 822 9476+</a></li>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="hero-txt text-center white-color">
							...
							<!-- Title -->
							<h2 class="h2-xl">Restaurant Delivery Drivers</h2>
						...
						<div class="form-holder">
							...
							<div>
								<form action="" class="search-form" >
									<input type="text" class="form-control" name="search1" placeholder="NIC Number" required value="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>">
									<div class="col-lg-12 text-center mx-auto"><br>
										<button type="submit" name="search"
											class="btn btn-md btn-red tra-red-hover submit">View Driver
											Details</button>
									</div>
								</form><br>
							</div>

							<h2 align="center">Search Driver Details</h2>
							<div class="result-table table-responsive mt-5 table-bordered">
								<table class="table table-striped">
									...
									$query = "SELECT * FROM drivers where NIC='$filtervalues'";
							...
							<p class="p-xl text-center">
								Fill in the form below to Add Driver Details or give us a call <a href="tel:0768228544">+94768228544</a>
							</p>

							<!-- Form -->
							<form action="../Demo-Static-Website/php/driverForm.php" method="post" name=""
								class="row contact-form">

								<!-- Form Input -->
								<div class="col-lg-6">
									<input type="text" name="name" class="form-control name" placeholder="Driver Name*"
										required>
								</div>

								<!-- Form Input -->
								<div class="col-lg-6">
									<input type="text" name="NIC" class="form-control NIC"
								...
								<!-- Form Input -->
								<div class="col-lg-6">
									<input type="text" name="VehicleNumber" class="form-control Vehicle Number"
										placeholder="Vehicle Number*" required>
								</div>

								<!-- Form Textarea -->
								<div class="col-md-12">
									<textarea name="note" class="form-control note" rows="4"
					...
					<div class="col-md-7 col-lg-6">
						<div class="banner-3-txt coffee-color">
							...
							<div class="stores-badge">
								...
								<!-- Google Play -->
								<a href="#" class="store">
									<img class="googleplay-original" src="images/googleplay.png"
										alt="googleplay-logo" />
								</a>
						...
						<div class="footer-img mb-40">
							...
							<ul class="text-center clearfix">
								<li><a href="#" target="_blank"><img class="insta-img" src="images/instagram/img-01.jpg"
											alt="insta-img"></a></li>
								<li><a href="#" target="_blank"><img class="insta-img" src="images/instagram/img-02.jpg"
											alt="insta-img"></a></li>
								<li><a href="#" target="_blank"><img class="insta-img" src="images/instagram/img-03.jpg"
											alt="insta-img"></a></li>
								<li><a href="#" target="_blank"><img class="insta-img" src="images/instagram/img-04.jpg"
											alt="insta-img"></a></li>
								<li><a href="#" target="_blank"><img class="insta-img" src="images/instagram/img-05.jpg"
											alt="insta-img"></a></li>
								<li><a href="#" target="_blank"><img class="insta-img" src="images/instagram/img-06.jpg"
											alt="insta-img"></a></li>
							</ul>
